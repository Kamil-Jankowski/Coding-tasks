...
*Memory Complexity*: Logarithmic, _O(log n)_

=== Task 14: Find Low/High Index
...
TIP: The array length can be in the millions with many duplicates.

*Runtime Complexity*: Logarithmic, _O(log n)_

*Memory Complexity*: Constant, _O(1)_

=== Task 15: Search Rotated Array
...
=== Task 2:
Create a method that counts enclosed (between "|") items (*).

The function is expected to return an INTEGER_ARRAY.
The function accepts following parameters:

. STRING s
. INTEGER_ARRAY startIndices
. INTEGER_ARRAY endIndices

Program reads input from the console in following format:
